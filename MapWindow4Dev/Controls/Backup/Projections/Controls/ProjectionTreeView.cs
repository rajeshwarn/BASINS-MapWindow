...
namespace MapWindow.Controls.Projections
{
    ...
    public class ProjectionTreeView : TreeView
    {
        ...
        private const string NODE_GEOGRAPHICAL = "Geographic";
        ...
        private ImageList CreateImageList()
        {
            ...
            bmp = new Bitmap(MapWindow.Controls.Properties.Resources.globe, new Size(16, 16));
            list.Images.Add(bmp);

            bmp = new Bitmap(MapWindow.Controls.Properties.Resources.map, new Size(16, 16));
            list.Images.Add(bmp);

            bmp = new Bitmap(MapWindow.Controls.Properties.Resources.map_add, new Size(16, 16));
            list.Images.Add(bmp);

            bmp = new Bitmap(MapWindow.Controls.Properties.Resources.map_delete, new Size(16, 16));
            list.Images.Add(bmp);
        ...
        /// </summary>
        public bool InitializeByExePath(string executablePath, MapWindow.Interfaces.IMapWin mapWin)
        {
        ...
        /// <returns></returns>
        public bool Initialize(string databaseName, MapWindow.Interfaces.IMapWin mapWin)
        {
            m_mapWin = mapWin;  // null is acceptable as well
            try
            {
                m_database = new ProjectionDatabase(databaseName, new MapWindow.Data.SQLiteProvider());
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        public bool Initialize(ProjectionDatabase database, MapWindow.Interfaces.IMapWin mapWin)
        {
            m_mapWin = mapWin;  // null is acceptable as well
