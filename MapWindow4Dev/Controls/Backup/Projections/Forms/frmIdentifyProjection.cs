...
namespace MapWindow.Controls.Projections
{
    ...
    {
        /// Refrence to MapWindow
        MapWindow.Interfaces.IMapWin m_mapWin = null;
        ...
        /// </summary>
        public frmIdentifyProjection(MapWindow.Interfaces.IMapWin mapWin): this(mapWin, null)
        {
        }
        ...
        /// </summary>
        public frmIdentifyProjection(MapWindow.Interfaces.IMapWin mapWin, MapWinGIS.Extents bounds)
        {
            InitializeComponent();

            if (mapWin == null)
            {
                throw new NullReferenceException("No reference to MapWindow was provided");
            }
        ...
        private void cboLayer_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            MapWindow.Interfaces.Layer layer = m_mapWin.Layers[(int)cboLayer.SelectedValue];
            if (layer != null)
            {
