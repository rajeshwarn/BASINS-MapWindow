...
namespace MapWindow.Controls.Data
{
    ...
    public partial class frmExportShapefile : Form
    {
        ...
        /// </summary>
        public frmExportShapefile(MapWindow.Interfaces.IMapWin mapWin)
        {
            InitializeComponent();

            if (mapWin == null)
                throw new ArgumentException("No refernce to MapWindow was passed");

            m_mapWin = mapWin;

            IEnumerable<MapWindow.Interfaces.Layer> layers =
            ...
            else
            {
                ...
                if (client.OpenConnection())
                {
                    ...
                    foreach (ListViewItem item in items)
                    {
                        ...
                        MapWindow.Interfaces.Layer layer = item.Tag as MapWindow.Interfaces.Layer;
