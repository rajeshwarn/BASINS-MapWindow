...
namespace MapWindow.Controls.General
{
    ...
    public partial class LayersDialog : Form
    {
        ...
        public LayersDialog(MapWindow.Interfaces.IMapWin mapWin, MapWindow.Interfaces.eLayerType[] layerTypes): this(mapWin, layerTypes, null)
        {
        }
        ...
        public LayersDialog(MapWindow.Interfaces.IMapWin mapWin, MapWindow.Interfaces.eLayerType[] layerTypes, IEnumerable<string> selection)
        {
            InitializeComponent();
            if (mapWin == null)
