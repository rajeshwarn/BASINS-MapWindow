...
namespace MapWindow.Controls.Projections
{
    ...
    public partial class frmChooseProjection : Form
    {
        ...
        /// </summary>
        public frmChooseProjection(MapWindow.Interfaces.IMapWin mapWin)
        {
            InitializeComponent();
        ...
        /// </summary>
        public frmChooseProjection(ProjectionDatabase database, MapWindow.Interfaces.IMapWin mapWin)
        {
            InitializeComponent();
