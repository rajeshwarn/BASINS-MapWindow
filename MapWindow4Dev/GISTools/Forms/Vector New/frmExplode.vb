...
Public Class frmExplode
    ...
    Private Sub cboLayer_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboLayer.SelectedIndexChanged
        ...
        If Not sf Is Nothing Then
            ...
            txtFilename.Text = ShapefileTools.GetAvailibleFileName(sf.Filename, "explode")
        End If
    End Sub
    ...
    Private Sub btnOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOk.Click
        ...
        Else
            ...
            If Not sf Is Nothing Then
                Dim result As MapWinGIS.Shapefile = sf.ExplodeShapes(chkSelectedOnly.Checked And chkSelectedOnly.Enabled)
