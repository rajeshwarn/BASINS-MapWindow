'********************************************************************************************************
'File Name: frmSortShapefile.vb
'Description: Sorts shapefile based on the attribute value
'********************************************************************************************************
...
Public Class frmSortShapefile

    ''' <summary>
    ''' Creates a new instance of the frmSortShapefile class
    ''' </summary>
    Public Sub New()
    ...
    Private Sub cboLayer_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboLayer.SelectedIndexChanged
        ...
        If Not sf Is Nothing Then
            ...
            txtFilename.Text = ShapefileTools.GetAvailibleFileName(sf.Filename, "sort")
        End If
    End Sub
    ...
    Private Sub btnOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOk.Click
        ...
        Else
            ...
            If Not sf Is Nothing Then
                ...
                Dim result As MapWinGIS.Shapefile = sf.Sort(cboField.SelectedIndex, chkAscending.Checked)
