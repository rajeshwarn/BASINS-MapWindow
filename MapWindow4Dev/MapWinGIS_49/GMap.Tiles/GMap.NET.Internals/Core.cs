...
namespace GMap.NET.Internals
{
   ...
   public partial class Core
   {
      ...
      public static readonly Guid SessionIdGuid = Guid.NewGuid();
      public static readonly Guid CompanyIdGuid = new Guid("3E35F098-CE43-4F82-9E9D-05C8B1046A45");
      public static readonly Guid ApplicationIdGuid = new Guid("FF328040-77B0-4546-ACF3-7C6EC0827BBB");
      public static volatile bool AnalyticsStartDone = false;
      public static volatile bool AnalyticsStopDone = false;
      ...
      public readonly Dictionary<LoadTask, Exception> FailedLoads = new Dictionary<LoadTask, Exception>();

      public static readonly int WaitForTileLoadThreadTimeout = 5 * 1000 * 60; // 5 min.
