...
namespace GMap.NET.CacheProviders
{
    ...
    /// <summary>
    /// SqLite provider for caching
    /// </summary>
    public partial class SQLitePureImageCache : PureImageCache
    {
        #region SqLite dynamic laoding
       #if !PocketPC
       #if !MONO
       ...
       static SQLitePureImageCache()
        ...
        protected string gtileCache;
        protected string dir;
        protected string db;
        protected bool Created = false;

        protected static readonly string singleSqlSelect = "SELECT Tile FROM main.TilesData WHERE id = (SELECT id FROM main.Tiles WHERE X={0} AND Y={1} AND Zoom={2} AND Type={3})";
        protected static readonly string singleSqlInsert = "INSERT INTO main.Tiles(X, Y, Zoom, Type, CacheTime) VALUES(@p1, @p2, @p3, @p4, @p5)";
        protected static readonly string singleSqlInsertLast = "INSERT INTO main.TilesData(id, Tile) VALUES((SELECT last_insert_rowid()), @p1)";

        protected string ConnectionString;

        protected readonly List<string> AttachedCaches = new List<string>();
        protected string finnalSqlSelect = singleSqlSelect;
        protected string attachSqlQuery = string.Empty;
        protected string detachSqlQuery = string.Empty;
        ...
        /// <summary>
        /// Rturns location of the GTile cache
        /// </summary>
        ...
        /// <summary>
        /// Location of the local cache. Folder name is expected
        /// </summary>
        ...
        /// <summary>
        /// Creates a new caching database database
        /// </summary>
        /// <param name="file">Database name</param>
        ...
        /// <summary>
        /// Adds a cetain amount of empty space to avoid further fragmentation
        /// </summary>
        ...
        /// <summary>
        /// Deletes preallocated space from the database
        /// </summary>
        ...
        #region Add time column
        /// <summary>
        /// Adds date column in the database
        /// </summary>
        ...
        #region Exports images from one database to the another
        /// <summary>
        /// Exports data from one database to the another
        /// </summary>
        /// <param name="sourceFile">Source database file</param>
        /// <param name="destFile">Destination datbase file</param>
        /// <returns></returns>
        ...
        #region Attach/detach/union query
        /// <summary>
        /// Builds the UNION query based on the all attached databases
        /// </summary>
        ...
        /// <summary>
        /// Attaches database to the cache
        /// </summary>
        /// <param name="db"></param>
        ...
        /// <summary>
        /// Detaches database from the cache
        /// </summary>
        /// <param name="db"></param>
        ...
        #region PureImageCache Members (put image, get image, delete older than)

        int preAllocationPing = 0;
        /// <summary>
        ///  Adds image to the cache
        /// </summary>
        bool PureImageCache.PutImageToCache(byte[] tile, int type, GPoint pos, int zoom)
      {
        ...
        /// <summary>
        /// Deletes images from the cache which are older then specified date
        /// </summary>
