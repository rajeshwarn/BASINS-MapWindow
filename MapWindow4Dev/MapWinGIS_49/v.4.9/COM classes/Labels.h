...
public:
	CLabels()
	{
		...
		m_avoidCollisions = VARIANT_TRUE;		// true
		...
		m_smoothingMode = AntiAlias;
		m_compositingQuality = HighQuality;
	}
	~CLabels()
	{
...
private:
	...
	tkSmoothingMode m_smoothingMode;
	tkCompositingQuality m_compositingQuality;
...
public:
	...
	STDMETHOD(get_CompositingQuality)(tkCompositingQuality* pVal);
	STDMETHOD(put_CompositingQuality)(tkCompositingQuality newVal);
	STDMETHOD(get_SmoothingMode)(tkSmoothingMode* pVal);
	STDMETHOD(put_SmoothingMode)(tkSmoothingMode newVal);
};
