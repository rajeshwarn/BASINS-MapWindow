...
// ***************************************************************
// Returns simple coordinates of the simple shape to reprsent point symbol (squar, star, cross)
...
//	  get_CrossShape()
// ***************************************************************
float* get_CrossShape(float size, /*float scaleX, float scaleY,*/ int numSides, float shapeRatio, double rotation)
{
