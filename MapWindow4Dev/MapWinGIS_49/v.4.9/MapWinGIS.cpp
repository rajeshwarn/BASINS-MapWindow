...
bool m_geosLoaded;
//std::set<CString> m_loadedModules;
//
//// ********************************************************
////     CheckDLL()
//// ********************************************************
//bool CheckDLL(CString moduleName)
//{
//	if (m_loadedModules.find(moduleName) != m_loadedModules.end())
//	{
//		// the module was loaded already
//		return true;
//	}
//	else
//	{
//		HINSTANCE hinstance = LoadLibrary ( moduleName ) ;
//		if (hinstance == NULL)
//		{
//			AfxMessageBox("The module can't be loaded: " + moduleName);
//			return false;
//		}
//		else
//		{
