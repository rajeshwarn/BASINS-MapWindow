========================================================================
		ActiveX Control DLL : MAPWINGIS
========================================================================

ControlWizard has created this project for your MAPWINGIS ActiveX Control
...
that make up your MAPWINGIS ActiveX Control DLL.
...
Map.h
	This file contains the declaration of the CMapView C++ class.

Map.cpp
	This file contains the implementation of the CMapView C++ class.

MapPpg.h
	This file contains the declaration of the CMapViewPropPage C++ class.

MapPpg.cpp
	This file contains the implementation of the CMapViewPropPage C++ class.

Map.bmp
	This file contains a bitmap that a container will use to represent the
	CMapView control when it appears on a tool palette.  This bitmap
	is included by the main resource file MapWinGIS.rc.
