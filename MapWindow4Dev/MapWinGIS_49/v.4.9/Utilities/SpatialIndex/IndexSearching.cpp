...
INDEXSEARCHING_API int selectShapesFromIndex(CSpatialIndexID spatialIndexID, double *lowVals, double *hiVals, QueryTypeFlags queryType, CIndexSearching *resulSet)
{
