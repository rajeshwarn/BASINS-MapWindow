...
namespace MapWinGeoProc.Dialogs
{
    ...
    /// </summary>
    public partial class BooleanElement : UserControl
    {
        #region Variables
        ...
        /// </summary>
        [Category("Appearance")]
        [Description("Gets or sets a boolean value that is true if the parameter is checked.")]
        public bool Value
        {
            get
            {
        ...
        /// </summary>
        [Category("Appearance")]
        [Description("Gets or sets the label that describes the checkbox.")]
        ...
        /// </summary>
        [Category("Behavior")]
        [Description("Gets or sets whether the checkbox is enabled.")]
        public bool CheckboxEnabled
        {
            get
            {
                return cbValue.Enabled;
            }
            set
            {
