...
namespace MapWinGeoProc.NTS.Topology.Algorithm
{
    ...
    public class MinimumDiameter
    {
        ...
        public virtual ICoordinate WidthCoordinate
        {
            get
            {
                ComputeMinimumDiameter();
        ...
        public virtual ILineString SupportingSegment
        {
            ...
            {
                ComputeMinimumDiameter();
                return inputGeom.Factory.CreateLineString(new Coordinate[] { minBaseSeg.cP0, minBaseSeg.cP1 });
            }
        }
        ...
        public virtual ILineString Diameter
        {
            get
            {
                ...
                Coordinate basePt = new Coordinate(minBaseSeg.Project(minWidthPt));
