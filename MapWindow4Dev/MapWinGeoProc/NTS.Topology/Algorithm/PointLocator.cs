...
namespace MapWinGeoProc.NTS.Topology.Algorithm
{
    ...
    public class PointLocator
    {
        ...
        public virtual bool Intersects(ICoordinate p, IGeometry geom)
        {
        ...
        public virtual Locations Locate(ICoordinate p, IGeometry geom)
        {
            if(geom.IsEmpty)
        ...
        /// <returns></returns>
        private Locations Locate(ICoordinate p, Polygon poly)
        {
            if (poly.IsEmpty) 
                return Locations.Exterior;
