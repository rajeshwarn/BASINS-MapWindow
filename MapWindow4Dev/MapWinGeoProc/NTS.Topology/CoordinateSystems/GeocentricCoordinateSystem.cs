		...
		public static IGeocentricCoordinateSystem WGS84
		{
			get
			{
				return new CoordinateSystemFactory().CreateGeocentricCoordinateSystem("WGS84 Geocentric",
					MapWinGeoProc.NTS.Topology.CoordinateSystems.HorizontalDatum.WGS84, MapWinGeoProc.NTS.Topology.CoordinateSystems.LinearUnit.Metre, 
					MapWinGeoProc.NTS.Topology.CoordinateSystems.PrimeMeridian.Greenwich);
			}
		}
