	...
	public class GeographicCoordinateSystem : HorizontalCoordinateSystem, IGeographicCoordinateSystem
	{
		...
		public static GeographicCoordinateSystem WGS84
		{
			get {
				...
				return new GeographicCoordinateSystem(MapWinGeoProc.NTS.Topology.CoordinateSystems.AngularUnit.Degrees,
					MapWinGeoProc.NTS.Topology.CoordinateSystems.HorizontalDatum.WGS84, MapWinGeoProc.NTS.Topology.CoordinateSystems.PrimeMeridian.Greenwich, axes,
