...
namespace MapWinGeoProc.NTS.Topology.CoordinateSystems
{
	...
	public class HorizontalDatum : Datum, IHorizontalDatum
	{
		...
		public static HorizontalDatum WGS84
		{
			get
			{
				return new HorizontalDatum(MapWinGeoProc.NTS.Topology.CoordinateSystems.Ellipsoid.WGS84, 
		...
		public static HorizontalDatum WGS72
		{
			get
			{
				HorizontalDatum datum = 
					new HorizontalDatum(MapWinGeoProc.NTS.Topology.CoordinateSystems.Ellipsoid.WGS72,
		...
		public static HorizontalDatum ETRF89
		{
			get
			{
				HorizontalDatum datum = new HorizontalDatum(MapWinGeoProc.NTS.Topology.CoordinateSystems.Ellipsoid.GRS80, null, DatumType.HD_Geocentric, 
		...
		public static HorizontalDatum ED50
		{
			get
			{
				return new HorizontalDatum(MapWinGeoProc.NTS.Topology.CoordinateSystems.Ellipsoid.International1924, new Wgs84ConversionInfo(-87,-98,-121,0,0,0,0), DatumType.HD_Geocentric,
		...
		{
			if (!(obj is MapWinGeoProc.NTS.Topology.CoordinateSystems.HorizontalDatum))
				return false;
