...
using MapWinGeoProc.NTS.Topology.CoordinateSystems;
using MapWinGeoProc.NTS.Topology.CoordinateSystems.Transformations;
...
namespace MapWinGeoProc.NTS.Topology.CoordinateSystems.Transformations
{
	...
	internal class GeocentricTransform : MathTransform
	{
		...
		private Point DegreesToMeters(Point lonlat)
		{
            ...
            double h = Double.IsNaN(lonlat.Z) ? 0 : lonlat.Z;
		...
		private Point MetersToDegrees(Point pnt)
		{
            ...
            double Z = Double.IsNaN(pnt.Z) ? 0 : pnt.Z;
