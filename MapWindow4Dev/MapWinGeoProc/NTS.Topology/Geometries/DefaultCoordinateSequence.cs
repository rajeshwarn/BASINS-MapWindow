    ...
    public class DefaultCoordinateSequence : ICoordinateSequence
    {
        ...
        public DefaultCoordinateSequence(ICoordinateSequence coordSeq)
        {
            ...
            for (int i = 0; i < coordinates.Length; i++)
                coordinates[i] = new Coordinate(coordSeq.GetCoordinateCopy(i));
        }
        ...
        public virtual void GetCoordinate(int index, ICoordinate coord)
        {
        ...
        {
            Envelope myEnv = new Envelope(env);
            for (int i = 0; i < coordinates.Length; i++)
                myEnv.ExpandToInclude(coordinates[i]);
            return myEnv;
        }
        ...
        public virtual object Clone()
        {
            ...
            for (int i = 0; i < coordinates.Length; i++)
                cloneCoordinates[i] = new Coordinate(coordinates[i]);            
        ...
        {
            int Count = coordinates.GetUpperBound(0)+1;
            Coordinate[] Coords = new Coordinate[Count];
            for (int I = 0; I < Count; I++)
            {
                Coords[I] = new Coordinate(coordinates[I]);
            }
            return Coords;
        }
