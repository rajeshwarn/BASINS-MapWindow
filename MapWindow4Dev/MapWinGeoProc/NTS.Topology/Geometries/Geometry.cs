...
using MapWinGeoProc.NTS.Topology.Operation.Overlay;
using MapWinGeoProc.NTS.Topology.Operation.Relate;
using MapWinGeoProc.NTS.Topology.Operation.Distance;
using MapWinGeoProc.NTS.Topology.Operation.Buffer;
using MapWinGeoProc.NTS.Topology.Operation.Valid;
using MapWinGeoProc.NTS.Topology.Operation.Predicate;
using MapWinGeoProc.NTS.Topology.Algorithm;
using MapWinGeoProc.NTS.Topology.IO;
using MapWinGeoProc.NTS.Topology.IO.GML2;
...
{   
    ...
    {        
        ...
        */
        ...
        {
            GMLWriter writer = new GMLWriter();
            return writer.Write(this).ToString();
        }
        ...
        /// <returns></returns>
        protected virtual bool Equal(Coordinate a, ICoordinate b, double tolerance) 
        {
            if (tolerance == 0)             
                return a.Equals(b);             
        ...
        {
            return (IGeometry)BufferOp.Buffer(this, distance, quadrantSegments, endCapStyle);
        }
        ...
        {
            return (IGeometry)BufferOp.Buffer(this, distance, quadrantSegments);
        }
        ...
        {
            return (IGeometry)BufferOp.Buffer(this, distance, endCapStyle);
        }
        ...
        {
            return (IGeometry)BufferOp.Buffer(this, distance);
        }
        ...
        public virtual bool Contains(IGeometry geom)
        {
            ...
            // general case
            return Relate((Geometry)geom).IsContains();
        }
        #endregion
        ...
        {
            return this.Intersects((new Envelope(env)).ToPolygon());
        }
        ...
        {
            return this.Intersects(new Point(x, y));
        }
        ...
        /// 
        /// </summary>
        public ICoordinate[] BaseCoordinates
        {
