...
namespace MapWinGeoProc.NTS.Topology.Geometries
{
    ...
    /// </summary>    
    [Serializable]
    public class LineSegment: IComparable, ILineSegment
    {
        ...
        /// </summary>
        public virtual Coordinate cP1
        {
            get { return new Coordinate(p1); }
        }

        /// <summary>
        /// returns the ICoordianteBase defining the second endpoint of the segment
        /// </summary>
        public virtual ICoordinate P0
        {
            get { return p0; }
            set { p0 = value; }
        }
        ...
        /// </summary>
        public virtual Coordinate cP0
        {
            get { return new Coordinate(p0); }
        }
        ...
        public virtual ICoordinate GetCoordinate(int i)
        {
            if (i == 0) return new Coordinate(p0);
        ...
        public virtual void SetCoordinates(ICoordinate p0, ICoordinate p1)
        {
            this.P0.X = p0.X;
            this.P0.Y = p0.Y;
            this.P1.X = p1.X;
        ...
        public virtual double Length
        {
            get
            {
                return new Coordinate(p0).Distance(P1);
            }
        }
        ...
        {
            return CGAlgorithms.DistanceLineLine(cP0, cP1, new Coordinate(ls.P0), new Coordinate(ls.P1));
        }
        ...
        {
            return CGAlgorithms.DistancePointLine(new Coordinate(p), cP0, cP1);
        }
        ...
        /// <param name="p"></param>
        /// <returns></returns>
        public virtual double DistancePerpendicular(ICoordinate p)
        {
            return CGAlgorithms.DistancePointLinePerpendicular(new Coordinate(p), cP0, cP1);
        }
        ...
        /// <param name="p"></param>
        /// <returns></returns>
        public virtual double ProjectionFactor(ICoordinate p)
        {
        ...
        /// <param name="p"></param>
        /// <returns></returns>
        public virtual ICoordinate Project(ICoordinate p)
        {
        ...
        /// </returns>
        public virtual ICoordinate ClosestPoint(ICoordinate p)
        {
            double factor = ProjectionFactor(p);
            if (factor > 0 && factor < 1) 
                return Project(p);
            double dist0 = new Coordinate(p0).Distance(p);
            double dist1 = new Coordinate(P1).Distance(p);
            if (dist0 < dist1)
                return new Coordinate(p0);
            else return new Coordinate(p1);
        }
        ...
        public virtual ICoordinate Intersection(ILineSegmentBase line)
        {
            LineIntersector li = new RobustLineIntersector();
            li.ComputeIntersection(cP0, cP1, new Coordinate(line.P0), new Coordinate(line.P1));
        ...
        public virtual int CompareTo(object o) 
        {
            ...
            int comp0 = new Coordinate(p0).CompareTo(other.P0);
            if (comp0 != 0) return comp0;
            return new Coordinate(p1).CompareTo(other.P1);
        }
        ...
        {
            return
                new Coordinate(p0).Equals(other.P0) && new Coordinate(p1).Equals(other.P1) || 
                new Coordinate(p0).Equals(other.P1) && new Coordinate(P1).Equals(other.P0);
        }
