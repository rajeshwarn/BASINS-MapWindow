...
{    
    ...
    public class PrecisionModel: IComparable
    {
        ...
        public virtual void ToInternal(ICoordinate cexternal, ICoordinate cinternal) 
        {
            if (IsFloating) 
            {
        ...
        /// </returns>
        [Obsolete("Use MakePrecise instead")]
        public virtual ICoordinate ToInternal(ICoordinate cexternal) 
        {
        ...
        public virtual ICoordinate ToExternal(ICoordinate cinternal) 
        {
        ...
        /// </param>
        [Obsolete("No longer needed, since internal representation is same as external representation")]
        public virtual void ToExternal(ICoordinate cinternal, ICoordinate cexternal) 
        {
        ...
        public virtual void MakePrecise(ICoordinate coord)
        {
