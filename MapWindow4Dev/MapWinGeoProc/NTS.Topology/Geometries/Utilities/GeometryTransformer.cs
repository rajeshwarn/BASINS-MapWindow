...
namespace MapWinGeoProc.NTS.Topology.Geometries.Utilities
{
    ...
    public class GeometryTransformer 
    {
        ...
        */
        ...
        /// <returns></returns>
        public virtual IGeometry Transform(IGeometry inputGeom)
        {
            ...
            throw new ArgumentException("Unknown Geometry subtype: " + inputGeom.GeometryType.ToString());
        }
        ...
        protected virtual IGeometry TransformMultiPoint(IMultiPoint geom, IGeometry parent) 
        {
            ...
            {
                IGeometry transformGeom = TransformPoint((Point) geom.GetGeometryN(i), geom);
        ...
        protected virtual IGeometry TransformPolygon(IPolygon geom, IGeometry parent) 
        {
            ...
            IGeometry shell = TransformLinearRing((ILinearRing) geom.ExteriorRing, geom);
            ...
            {
                IGeometry hole = TransformLinearRing((ILinearRing) geom.GetInteriorRingN(i), geom);
