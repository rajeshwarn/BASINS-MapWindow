...
namespace MapWinGeoProc.NTS.Topology.GeometriesGraph
{
    ...
    public class EdgeEnd : IComparable
    {
        ...
        /// <param name="p0"></param>
        /// <param name="p1"></param>
        public EdgeEnd(Edge edge, ICoordinate p0, ICoordinate p1) : this(edge, p0, p1, null) { }
        ...
        public EdgeEnd(Edge edge, ICoordinate p0, ICoordinate p1, Label label) : this(edge)
        {
            Init(p0, p1);
            this.label = label;
        }
        ...
        /// <param name="p0"></param>
        /// <param name="p1"></param>
        protected virtual void Init(ICoordinate p0, ICoordinate p1)
        {
            this.p0 = p0;
            this.p1 = p1;
            dx = p1.X - p0.X;
        ...
        /// 
        /// </summary>
        public virtual ICoordinate DirectedCoordinate
        {
            get
            {
                return p1;
