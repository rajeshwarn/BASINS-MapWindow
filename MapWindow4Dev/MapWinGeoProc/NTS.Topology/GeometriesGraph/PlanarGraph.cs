...
namespace MapWinGeoProc.NTS.Topology.GeometriesGraph
{
    ...
    {        
        ...
        /// <returns></returns>
        public virtual bool IsBoundaryNode(int geomIndex, ICoordinate coord)
        {
        ...
        /// <param name="p1"></param>
        /// <returns> The edge, if found <c>null</c> if the edge was not found.</returns>
        public virtual Edge FindEdge(ICoordinate p0, ICoordinate p1)
        {
        ...
        ///<param name="p1"></param>
        /// <returns> The edge, if found <c>null</c> if the edge was not found.</returns>
        public virtual Edge FindEdgeInSameDirection(ICoordinate p0, ICoordinate p1)
        {
            for (int i = 0; i < edges.Count; i++) 
            {
                Edge e = (Edge) edges[i];
