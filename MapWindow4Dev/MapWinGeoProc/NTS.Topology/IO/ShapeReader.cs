...
namespace MapWinGeoProc.NTS.Topology.IO
{
    ...
    public class ShapeReader
    {
        ...
        /// <returns></returns>
        public virtual IGeometry ReadPoint(BinaryReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public virtual IGeometry ReadLineString(BinaryReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public virtual IGeometry ReadPolygon(BinaryReader reader)
        {
            ReadBoundingBox(reader);  // Jump boundingbox
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public virtual IGeometry ReadMultiPoint(BinaryReader reader)
        {
            ReadBoundingBox(reader);  // Jump boundingbox
        ...
        /// <returns></returns>
        public virtual ILineString CreateLineString(Coordinate[] coords)
        {
        ...
        /// <param name="coords"></param>
        /// <returns></returns>
        public virtual IGeometry CreateMultiLineString(int numPoints, int[] indexParts, ICoordinate[] coords)
        {
            // Support vars
        ...
        /// <param name="coords"></param>
        /// <returns></returns>
        public virtual IGeometry CreateSingleOrMultiPolygon(int numPoints, int[] indexParts, ICoordinate[] coords)
        {
            // Support vars
            int i = 0;
            int index = 0;
            ...
            ILinearRing[] shells = new LinearRing[indexParts.Length];
            ...
            if (polygonIndex.Count == 1)
            {
                ...
                ILinearRing[] holes = new LinearRing[shells.Length - 1];
            ...
            else
            {
                ...
                IPolygon[] polygons = new Polygon[polygonIndex.Count];   // Array containing all Polygons                                              
        ...
        /// <param name="coords"></param>
        /// <returns></returns>
        public virtual IPolygon CreateSimpleSinglePolygon(Coordinate[] coords)
        {
        ...
        /// <param name="coords"></param>
        /// <returns></returns>
        public virtual IMultiPoint CreateMultiPoint(Coordinate[] coords)
        {
        ...
        /// <returns></returns>
        public virtual IGeometryCollection CreateGeometryCollection(IList list)
        {            
            IGeometry[] geometries = (Geometry[])(new ArrayList(list).ToArray(typeof(Geometry)));
