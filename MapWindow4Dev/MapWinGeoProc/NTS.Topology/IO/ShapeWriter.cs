...
namespace MapWinGeoProc.NTS.Topology.IO
{
    ...
    public class ShapeWriter
    {
        ...
        public virtual void Write(ICoordinate coordinate, BinaryWriter writer)
        {
        ...
        /// <param name="writer"></param>
        public virtual void WriteBoundingBox(IGeometry geometry, BinaryWriter writer)
        {
        ...
        /// <param name="geometry"></param>
        /// <returns></returns>
        public virtual byte[] GetBytes(IGeometry geometry)
        {
        ...
        /// <param name="geometry"></param>
        /// <returns></returns>
        public virtual int GetBytesLength(IGeometry geometry)
        {
