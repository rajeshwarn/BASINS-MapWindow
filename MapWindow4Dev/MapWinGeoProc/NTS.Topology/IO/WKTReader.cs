...
namespace MapWinGeoProc.NTS.Topology.IO
{
    ...
    public class WKTReader 
    {
        ...
        /// </summary>
        public WKTReader() : this(new GeometryFactory().Default) { }
        ...
        public WKTReader(IGeometryFactory geometryFactory) 
        {
            ...
            precisionModel = new PrecisionModel(geometryFactory.PrecisionModel);
        }
        ...
        /// </returns>
        public virtual IGeometry Read(string wellKnownText) 
        {
        ...
        /// </returns>
        public virtual IGeometry Read(TextReader reader) 
        {
