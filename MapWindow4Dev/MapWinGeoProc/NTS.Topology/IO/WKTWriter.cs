...
namespace MapWinGeoProc.NTS.Topology.IO
{
    ...
    public class WKTWriter 
    {
        ...
        private void WriteFormatted(Geometry geometry, bool isFormatted, TextWriter writer)
        {
            ...
            formatter = CreateFormatter(new PrecisionModel(geometry.PrecisionModel));
        ...
        private void AppendGeometryTaggedText(IGeometry geometry, int level, TextWriter writer)
        {
            ...
            if (geometry is Point) 
            {
                ...
                AppendPointTaggedText(point.Coordinate, level, writer, new PrecisionModel(point.PrecisionModel));
            }
        ...
        /// </param>
        private void AppendPointTaggedText(ICoordinate coordinate, int level, TextWriter writer, 
        ...
        private void AppendLineStringText(ILineString lineString, int level, bool doIndent, TextWriter writer)
        {
            ...
            else 
            {
                ...
                for (int i = 0; i < lineString.NumPoints; i++) 
                {
                    ...
                    AppendCoordinate(lineString.GetCoordinateN(i), writer, new PrecisionModel(lineString.PrecisionModel));
                }
                writer.Write(")");
            }
        }
        ...
        private void AppendMultiPointText(IMultiPoint multiPoint, int level, TextWriter writer)
        {
            ...
            else 
            {
                ...
                {
                    if (i > 0) writer.Write(", ");                    
                    AppendCoordinate(((Point) multiPoint.GetGeometryN(i)).Coordinate, writer, new PrecisionModel(multiPoint.PrecisionModel));
                }
                writer.Write(")");
            }
        }
