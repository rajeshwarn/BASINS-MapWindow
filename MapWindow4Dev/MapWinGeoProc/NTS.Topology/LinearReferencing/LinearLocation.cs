...
namespace MapWinGeoProc.NTS.Topology.LinearReferencing
{
    ...
    public class LinearLocation : IComparable<LinearLocation>, IComparable, ICloneable
    {
        ...
        public virtual void Clamp(IGeometry linear)
        {
        ...
        public virtual void SnapToVertex(IGeometry linearGeom, double minDistance)
        {
        ...
        public virtual void SetToEnd(IGeometry linear)
        {
        ...
        public virtual bool IsValid(IGeometry linearGeom)
        {
