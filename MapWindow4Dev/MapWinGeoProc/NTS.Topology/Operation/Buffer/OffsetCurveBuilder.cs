...
namespace MapWinGeoProc.NTS.Topology.Operation.Buffer
{
    /// <summary>
    ...
    {        
        ...
        */
        ...
        public virtual IList GetLineCurve(ICoordinate[] inputPts, double distance)
        {
        ...
        /// </summary>
        /// <returns>A List of Coordinate[].</returns>
        public virtual IList GetRingCurve(ICoordinate[] inputPts, Positions side, double distance)
        {
            IList lineList = new ArrayList();
            Init(distance);
        ...
        private void AddNextSegment(ICoordinate p, bool addStartPoint)
        {
            ...
            { 
                ...
                else 
                {
                    ...
                    */
                    if (new Coordinate(offset0.P1).Distance(offset1.P0) < distance / 1000.0) 
                        AddPt(offset0.P1);                    
                    else 
                    {
