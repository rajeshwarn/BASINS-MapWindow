...
namespace MapWinGeoProc.NTS.Topology.Operation.Buffer
{
    ...
    {        
        ...
        private void AddPolygon(IPolygon p)
        {
            ...
            ILinearRing shell = (ILinearRing)p.ExteriorRing;
        ...
        private void AddPolygonRing(ICoordinate[] coord, double offsetDistance, Positions side, Locations cwLeftLoc, Locations cwRightLoc)
        {
