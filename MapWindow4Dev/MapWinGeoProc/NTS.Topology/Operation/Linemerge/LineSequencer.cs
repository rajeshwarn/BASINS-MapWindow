...
using MapWinGeoProc.NTS.Topology.Planargraph.Algorithm;
...
namespace MapWinGeoProc.NTS.Topology.Operation.Linemerge
{
    /// <summary>
    /// <para>
    ...
    public class LineSequencer
    {
        ...
        public static bool IsSequenced(Geometry geom)
        {
            ...
            var prevSubgraphNodes = new Iesi.Collections.Generic.SortedSet <ICoordinate>();
        ...
        private IGeometryFactory factory = new GeometryFactory();
        ...
        public virtual void Add(IGeometry geometry) 
        {
        ...
        public virtual IGeometry GetSequencedLineStrings()
        {
            ComputeSequence();
        ...
        private IGeometry BuildSequencedGeometry(IList sequences)
        {
            ...
            return new GeometryFactory(factory).BuildGeometry(lines);
        }
