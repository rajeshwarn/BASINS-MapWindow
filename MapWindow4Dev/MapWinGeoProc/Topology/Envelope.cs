...
namespace MapWinGeoProc.Topology
{
    ...
    public class Envelope
    {
        ...
        public Envelope(double MinX, double MaxX, double MinY, double MaxY, double MinZ, double MaxZ)
        {
            xMin = MinX;
            yMin = MinY;
            xMax = MaxX;
        ...
        public bool Intersects(LineSegment Seg)
        {
            ...
            if (Intersects(Seg.StartPoint)) return true;
            if (Intersects(Seg.EndPoint)) return true;
        ...
        public Envelope Intersection(Envelope Rectangle2)
        {
        ...
        public MapWinGIS.Extents ToMapWinEnvelope()
        {
            ...
            mwEnvelope.SetBounds(xMin, yMin, zMin, xMax, yMax, zMax);
            return mwEnvelope;
        }
        /// <summary>
        ...
        public List<LineSegment> ToLineSegments()
        {
            ...
            // Xmin face
            SegList.Add(new LineSegment(xMin, yMin, zMin, xMin, yMin, zMax));
            SegList.Add(new LineSegment(xMin, yMax, zMin, xMin, yMax, zMax));
            SegList.Add(new LineSegment(xMin, yMin, zMin, xMin, yMax, zMin));
            SegList.Add(new LineSegment(xMin, yMin, zMax, xMin, yMax, zMax));

            // Xmax face
            SegList.Add(new LineSegment(xMax, yMin, zMin, xMin, yMin, zMax));
            SegList.Add(new LineSegment(xMax, yMax, zMin, xMin, yMax, zMax));
            SegList.Add(new LineSegment(xMax, yMin, zMin, xMin, yMax, zMin));
            SegList.Add(new LineSegment(xMax, yMin, zMax, xMin, yMax, zMax));

            // Connect xMin to Xmax
            SegList.Add(new LineSegment(xMin, yMin, zMin, xMax, yMin, zMin));
            SegList.Add(new LineSegment(xMin, yMax, zMin, xMax, yMax, zMin));
            SegList.Add(new LineSegment(xMin, yMin, zMax, xMax, yMin, zMax));
            SegList.Add(new LineSegment(xMin, yMax, zMax, xMax, yMax, zMax));
            return SegList;
        }
        #endregion
