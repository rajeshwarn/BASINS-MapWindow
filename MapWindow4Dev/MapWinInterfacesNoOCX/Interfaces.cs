...
namespace MapWindow
{
	namespace Interfaces
	{
		...
		public interface Draw
		{
            ...
            void AddDrawingLabel(int DrawHandle, string Text, System.Drawing.Color Color, double x, double y, Object hJustification);
            ...
            void AddDrawingLabelEx(int DrawHandle, string Text, System.Drawing.Color Color, double x, double y, Object hJustification, double Rotation);
		...
		public interface View
		{
            ...
            /// a Object object. Last entry is most recent zoom.
            /// </summary>
            ...
            Object ShapeDrawingMethod { get; set; }
		...
		public interface Layer
		{
			...
			void AddLabel(string Text, System.Drawing.Color TextColor, double xPos, double yPos, Object Justification);
			...
			/// <param name="Justification">Text justification.  Can be hjCenter, hjLeft or hjRight.</param>
			/// <param name="Rotation">The rotation angle for the label.</param>
			void AddLabelEx(string Text, System.Drawing.Color TextColor, double xPos, double yPos, Object Justification, double Rotation);
			...
			/// <c>Object</c> or a <c>Object</c>.  If the layer is a grid layer the 
			/// <c>Object</c> object can be retrieved using the <c>GetGridObject</c> method. 
			/// </summary>
			Object GetObject();
			...
			/// <summary>
			/// Returns the <c>Object</c> object associated with the layer.  If the layer is not a 
			/// grid layer, "Nothing" will be returned.
			/// </summary>
			Object GetGridObject{get;}
			...
			/// </summary>
			Object DynamicVisibilityExtents{get; set;}
			...
			long UserPointImageListAdd(Object newValue);
			...
			Object UserPointImageListItem(long ImageIndex);
        ...
        public interface Layers : System.Collections.IEnumerable
		{
			...
			/// </summary>
			/// <returns>Returns a <c>Layer</c> object.</returns>
			Layer Add(ref Object ImageObject);

			/// <summary>
			/// Adds an <c>Image</c> layer to the MapWindow with the specified layer name.
			/// </summary>
			/// <returns>Returns a <c>Layer</c> object.</returns>
			Layer Add(ref Object ImageObject, string LayerName);
            ...
            /// <returns>Returns a <c>Layer</c> object.</returns>
            Layer Add(ref Object ImageObject, string LayerName, bool Visible, int TargetGroup,int LayerPosition);
			...
			/// </summary>
			/// <returns>Returns a <c>Layer</c> object.</returns>
			Layer Add(ref Object ShapefileObject, string LayerName, int Color, int OutlineColor);

			/// <summary>
			/// Adds a <c>Shapefile</c> layer to the MapWindow with the specified properties.
			/// </summary>
			/// <returns>Returns a <c>Layer</c> object.</returns>
			Layer Add(ref Object ShapefileObject, string LayerName, int Color, int OutlineColor, int LineOrPointSize);

			/// <summary>
			/// Adds a <c>Grid</c> layer to the MapWindow, with the specified coloring scheme.
			/// </summary>
			/// <returns>Returns a <c>Layer</c> object.</returns>
			//Layer Add(ref Object GridObject, ObjectColorScheme ColorScheme);

			/// <summary>
			/// Adds a <c>Grid</c> object to the MapWindow with the specified properties.
			/// </summary>
			/// <returns>Returns a <c>Layer</c> object.</returns>
			//Layer Add(ref Object GridObject, ObjectColorScheme ColorScheme, string LayerName);
			...
			/// <returns></returns>
			//bool RebuildGridLayer(int LayerHandle, Object GridObject, ObjectColorScheme ColorScheme);
		...
		public interface Project
		{
            ...
            /// <summary>
            /// Loads a symbology for a specified layer from a project file. Assume the filename ans layer name of the specified layer can be found in the project file
            /// </summary>
		...
		public interface Reports
		{
			...
			/// <summary>
			/// Returns a <c>Object</c> of the view at the specified extents.
			/// </summary>
			/// <param name="BoundBox">The area that you wish to take the picture of.  Uses projected map units.</param>
			Object GetScreenPicture(Object BoundBox);
