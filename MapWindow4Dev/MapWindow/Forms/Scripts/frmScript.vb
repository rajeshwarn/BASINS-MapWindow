...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        '
        Me.SplitContainer1.Panel2.Controls.Add(Me.txtScript)
        '
        'GroupBox2
        '
        ...
        'rdCS
        '
        Me.rdCS.Checked = True
        resources.ApplyResources(Me.rdCS, "rdCS")
        Me.rdCS.Name = "rdCS"
        Me.rdCS.TabStop = True
        '
        'txtScript
        '
        ...
        Me.MenuStrip1.Items.AddRange(New System.Windows.Forms.ToolStripItem() {Me.ToolStripMenuItem1, Me.ToolStripMenuItem6, Me.mnuHelp})
...
#End Region
    ...
    Private Sub rdLangOrOutput_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Public Sub RunSavedScript()
        ...
        MapWinUtility.Logger.Dbg("In MapWindow.RunSavedScript()")
        ...
        Dim sPluginFolder As String = IO.Path.Combine(frmMain.Plugins.PluginFolder, "BASINS")

        Dim assy As Assembly
        assy = MapWinUtility.Scripting.PrepareScript(System.IO.Path.GetExtension(pFileName), Nothing, txtScript.Text, errors, sPluginFolder)

        If (rdPlugin.Checked) Then
            frmMain.Plugins.AddFromFile(assy.Location)
        Else
    ...
    Private Sub Run()
        ...
        MapWinUtility.Logger.Dbg("In MapWindow.Run()")
...
#Region "Radio button events"
    Private Sub rdCS_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdCS.CheckedChanged
        If (rdScript.Checked = True) Then
            txtScript.Text = pDefaultScript_CS
            txtScript.SetCS()
        ElseIf (rdPlugin.Checked = True) Then
            txtScript.Text = pDefaultPlugin_CS
            txtScript.SetCS()
        End If
    End Sub

    Private Sub rdVBNet_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdVBNet.CheckedChanged
        If (rdScript.Checked = True) Then
            txtScript.Text = pDefaultScript_VB
            txtScript.SetVB()
        ElseIf (rdPlugin.Checked = True) Then
    ...
    Private Sub rdPlugin_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdPlugin.CheckedChanged
        If (rdCS.Checked = True) Then
            txtScript.Text = pDefaultPlugin_CS
            txtScript.SetCS()
        ElseIf (rdVBNet.Checked = True) Then
            txtScript.Text = pDefaultPlugin_VB
            txtScript.SetVB()
        End If
    End Sub

    Private Sub rdScript_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdScript.CheckedChanged
        If (rdCS.Checked = True) Then
            txtScript.Text = pDefaultScript_CS
            txtScript.SetCS()
        ElseIf (rdVBNet.Checked = True) Then
