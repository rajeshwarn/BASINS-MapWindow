...
#Region "Initialization"
    ...
    Public Function CreateLegendPanel() As WeifenLuo.WinFormsUI.Docking.DockContent
        ...
        tabs.TabPages.Add(New TabPage())
        tabs.TabPages(0).Text = "Layers"
        tabs.TabPages(1).Text = "Toolbox"
        tabs.Dock = DockStyle.Fill

        ' legend
        Legend.Dock = DockStyle.Fill
        tabs.TabPages(0).Controls.Add(Legend)

        ' gis toolbox
        m_GisToolbox = New MapWindow.Controls.GisToolbox.GisToolbox()
        m_GisToolbox.Dock = DockStyle.Fill

        m_GisToolbox.SplitterDistance = m_GisToolbox.Height * 0.9
        tabs.TabPages(1).Controls.Add(m_GisToolbox)
...
#Region "General Functions"
    ...
    Public Sub SetModified(ByVal Status As Boolean)
        ...
        If (AppInfo.ShowMapWindowVersion) Then
            MapMain.ShowVersionNumber = True
        Else
