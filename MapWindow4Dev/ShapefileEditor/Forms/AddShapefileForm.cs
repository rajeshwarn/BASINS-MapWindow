...
namespace ShapefileEditor
{
    ...
    public class AddShapefileForm : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            // lblFilename
            // 
            this.lblFilename.AccessibleDescription = null;
            this.lblFilename.AccessibleName = null;
            resources.ApplyResources(this.lblFilename, "lblFilename");
            this.lblFilename.Font = null;
        ...
        private void btnOK_Click(object sender, System.EventArgs e)
        {
            ...
            if (System.IO.File.Exists(txtFilename.Text) == true)
            {
                ...
                {
                    // Paul Meems - 17 Oct 2011, Fix for issue #2073: Creating new shapefile over existing one crashes 
                    var shapefilename = this.txtFilename.Text;
                    MapWinGeoProc.DataManagement.DeleteShapefile(ref shapefilename);
                    ...
                    //try { System.IO.File.Delete(shp); }
                    //catch { }
                    //try { System.IO.File.Delete(shx); }
                    //catch { }
                    //try { System.IO.File.Delete(dbf); }
                    //catch { }
                }
                else
                {
