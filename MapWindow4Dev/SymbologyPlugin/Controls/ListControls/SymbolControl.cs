...
namespace mwSymbology.Controls
{
    ...
    [ToolboxItem(true)]
    public partial class SymbolControl : ListControl
    {
        ...
        public SymbolControl()
        {
            ...
            for (int i = 0; i < this.ItemCount; i++)
            {
                ...
                sdo.FillColor = MapWinUtility.Colors.ColorToUInteger(Color.Orange);
                _icons.Add(sdo);
            }
        ...
        public override Color ForeColor
        {
            ...
            set
            {
                ...
                {
                    _icons[i].FillColor = MapWinUtility.Colors.ColorToUInteger(value);
                }
                base.Redraw();
            }
        }
        ...
        void PointSymbolControl_OnDrawItem(System.Drawing.Graphics graphics, System.Drawing.RectangleF rect, int itemIndex, bool selected)
        {
            ...
            sdo.DrawPoint(ptr, rect.X + 1.0f, rect.Y +1.0f, (int)rect.Width -2, (int)rect.Height -2, MapWinUtility.Colors.ColorToUInteger(this.BackColor));
            graphics.ReleaseHdc();
       }
    }
}
