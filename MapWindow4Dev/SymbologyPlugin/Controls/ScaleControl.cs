...
using System.Drawing.Text;
    ...
    public partial class ScaleControl : UserControl
    {
        ...
        private TextRenderingHint m_renderingHint = TextRenderingHint.SystemDefault;
        ...
        public TextRenderingHint TextRendringHint
        {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            if (!_locked)
            {
                ...
                Font font = this.Font; //new Font("Microsoft Sans Serif", 8.0f);
                ...
                for (int i = 0; i < 10; i++)
                {
                    ...
                    g.DrawString(s, font, new SolidBrush(Color.Black), r);
                }
