    ...
    public partial class TransparencyControl : UserControl
    {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            if (!_locked)
            {
                ...
                rect = new Rectangle(BAND_OFFSET, 0, this.ClientRectangle.Width - textBox1.Width - 2 * BAND_OFFSET, BAND_HEIGHT);
        ...
        {
            float width = this.ClientRectangle.Width - textBox1.Width - 2 * BAND_OFFSET;
        ...
        {
            int bandWidth = this.ClientRectangle.Width - textBox1.Width - 2 * BAND_OFFSET;
