...
namespace mwSymbology.Forms
{
    ...
    /// </summary>
    public partial class frmGenerateCategories : Form
    {
        // Refrence to the plug-in
        private SymbologyPlugin _plugin;
        ...
        /// <summary>
        /// Generates a new instance of the frmGenerateCategories class
        /// </summary>
        public frmGenerateCategories(SymbologyPlugin plugin, MapWinGIS.Shapefile sf, int layerHandle)
        {
            InitializeComponent();
            ...
            SymbologySettings settings = _plugin.get_LayerSettings(layerHandle);
            ...
            // dummy color scheme
            _plugin.LayerColors.SetDefaultColorScheme(_shapefile);

            // initializing for list of color schemes
            icbColorScheme.ColorSchemes = _plugin.LayerColors;
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            {
                SymbologyPlugin.MessageBoxError("Number of categories isn't a valid interger.");
                return;
            }
        ...
        {
            LegendControl.Layer layer = _plugin.m_mapWin.View.LegendControl.Layers.ItemByHandle(_layerHandle);
        ...
        {
            SymbologySettings settings = SymbologyPlugin.get_LayerSettings(_layerHandle, _plugin.m_mapWin);
        ...
        {
            frmColorSchemes form = new frmColorSchemes(ref _plugin.LayerColors);
            if (form.ShowDialog(this) == DialogResult.OK)
            {
                this.icbColorScheme.ColorSchemes = _plugin.LayerColors;
