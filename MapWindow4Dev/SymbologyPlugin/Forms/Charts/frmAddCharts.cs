...
namespace mwSymbology.Forms
{
    ...
    public partial class frmAddCharts : Form
    {
        ...
        /// <summary>
        /// Creates a new instance of the frmAddCharts class
        /// </summary>
        public frmAddCharts(MapWinGIS.Shapefile sf, MapWindow.Interfaces.IMapWin mapWin)
        {
            InitializeComponent();
