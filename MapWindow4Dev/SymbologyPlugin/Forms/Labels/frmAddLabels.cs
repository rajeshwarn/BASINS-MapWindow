...
namespace mwSymbology.Forms
{
    ...
    public partial class frmAddLabels : Form
    {
        ...
        /// <summary>
        /// Creates a new instance of the frmAddLabels
        /// </summary>
        public frmAddLabels(MapWindow.Interfaces.IMapWin mapWin, MapWinGIS.Shapefile sf, tkLabelAlignment alignment)
        {
            InitializeComponent();

            if (sf == null || mapWin == null)
            {
                throw new Exception("frmAddLabels: Unexpected null parameter");
            }
            ...
            else
            {
                ...
                //throw new Exception("frmAddLabels: invalid shapefile type");
            }
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            Callback cback = new Callback(m_mapWin);
