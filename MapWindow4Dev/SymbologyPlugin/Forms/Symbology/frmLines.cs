...
namespace mwSymbology.Forms
{
    ...
    public partial class frmLines : Form
    {
        ...
        // handle of the layer the options are applied to
        ...
        /// </summary>
        public frmLines(ShapeDrawingOptions options, MapWindow.Interfaces.IMapWin mapWin, int layerHandle, bool applyDisabled)
        {
            InitializeComponent();
            ...
            cboOrientation.Items.Add("Perpindicular");

            cboLineType.Items.Clear();
            cboLineType.Items.Add("Simple");
            ...
            if (dgv.SelectedRows.Count > 0)
            {
                ...
                if (line != null)
                {
                    ...
                    if (cboLineType.SelectedIndex == 0)
                    {
                        ...
                        line.Color = MapWinUtility.Colors.ColorToUInteger(clpOutline.Color);
                    }
                    else
                    {
                        ...
                        line.Color = MapWinUtility.Colors.ColorToUInteger(clpMarkerFill.Color);
                        line.MarkerOutlineColor = MapWinUtility.Colors.ColorToUInteger(clpMarkerOutline.Color);
            ...
            if (dgv.SelectedRows.Count > 0)
            {
                ...
                if (line != null)
                {
                    ...
                    if (line.LineType == tkLineType.lltSimple)
                    {
                        ...
                        clpOutline.Color = MapWinUtility.Colors.IntegerToColor(line.Color);
                        _noEvents = false;
                    }
                    else
                    {
                        ...
                        clpMarkerFill.Color = MapWinUtility.Colors.IntegerToColor(line.Color);
                        clpMarkerOutline.Color = MapWinUtility.Colors.IntegerToColor(line.MarkerOutlineColor);
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                _options.LinePattern.AddLine(MapWinUtility.Colors.ColorToUInteger(Color.Black), 1.0f, tkDashStyle.dsSolid);
            }
            else
            {
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            SymbologyPlugin.SaveLayerOptions(_mapWin, _layerHandle);
