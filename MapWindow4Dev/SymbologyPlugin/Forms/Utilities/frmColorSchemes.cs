...
namespace mwSymbology.Forms
{
    ...
    /// </summary>
    public partial class frmColorSchemes : Form
    {
        // Reference to the actual list of color schemes        
        private List<ColorBlend> _schemes = null;
        
        // Reference to color schemes object to change
        private ColorSchemes _colorSchemes = null;

        // Prevents control from triggering the events while initializing
        ...
        public frmColorSchemes(ref ColorSchemes colorSchemes)
        {
            InitializeComponent();
            ...
            int index = (colorSchemes.Type == ColorSchemeType.Layer) ? 1 : 0;
        ...
        private ColorBlend CloneColorBlend(ColorBlend blend)
        {
            ...
            ColorBlend newBlend = new ColorBlend(blend.Colors.Length);
        ...
        {
            if (MessageBox.Show("Do you want to delete the selected color scheme?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
