...
namespace mwSymbology.Forms
{
    ...
    public partial class frmOptionsChooser : Form
    {
        ...
        /// </summary>
        public frmOptionsChooser(string filename, int handle, MapWindow.Interfaces.IMapWin mapWin)
        {
            InitializeComponent();
            ...
            SymbologyPlugin.FillSymbologyList(listView1, filename, false, ref m_NoEvents);
        ...
        private void dgv_CurrentCellChanged(object sender, EventArgs e)
        {
            ...
            {
                lblDescription.Text = SymbologyPlugin.GetSymbologyDescription(SymbologyType.Random);
            ...
            {
                name = "";
                lblDescription.Text = SymbologyPlugin.GetSymbologyDescription(SymbologyType.Default);
                lblDescription.Refresh();
            }
