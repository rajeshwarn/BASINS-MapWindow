...
Error_Handler:
    ...
    Private Function Airy_A(ByVal x As Double) As Double
        Dim AI As Double, BI As Double, AD As Double, BD As Double
...
#Region "special functions"
    ...
    Sub FCS(ByVal x As Double, ByRef c As Double, ByRef s As Double)
        ...
        ' =================================================
        Const EPS As Double = 0.000000000000001
        Dim XA As Double, PX As Double, t As Double, T0 As Double, T2 As Double, r As Double, k As Integer, m As Double, SU As Double, F As Double, F0 As Double, F1 As Double, Q As Double, G As Double
